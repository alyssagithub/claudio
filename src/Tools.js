  ...
  return [
    ...
    },
    {
      ...
      Run: async (Input) => {
        ...
        const Sent = { code: Input.code, target: Where, readOnly: Input.readOnly === true, description: Input.description };
    ...
    },
    {
      ...
      Run: async (Input) => {
        ...
        return { content: [{ type: "text", text: Said(await Reach("rbxm", { base64: Body, path: Input.path, description: Input.description }), "Studio did not say what happened.") }] };
      },
    },
    {
      Name: "logs",
